...
class VueSalleEdit {
    ...
    init(form) {
        ...
        this.form.btnAjouterEquipt.onclick = function () {
            vueSalleEdit.ajouterEquiptClick();
        };
        this.form.btnValiderEquipt.onclick = function () {
            vueSalleEdit.validerEquiptClick();
        };
        this.form.btnAnnulerEquipt.onclick = function () {
    ...
    validerEquiptClick() {
        ...
        this.verifQte();
        correct =
            this.traiteErreur(this._erreur.listeEquipt, this.form.lblSelectEquiptErreur) && correct;
        ...
        if (correct) {
            ...
            const unTypEquiptBySalle = new UnTypEquiptBySalle(unTypEquipt, parseInt(this._form.edtQte.value));

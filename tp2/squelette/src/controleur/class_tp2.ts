...
class VueTp2 {
    ...
    init(form : TTp2Form) : void {
        ...
        this.form.chkTri.onchange = function ():void { vueTp2.trierListe(); }
        this.form.btnVider.onclick = function ():void { vueTp2.viderListe(); }
        this.form.btnSupprimer.onclick = function ():void { vueTp2.supprimerLigne(); }
    }

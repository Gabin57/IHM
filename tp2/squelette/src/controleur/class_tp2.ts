...
class VueTp2 {
    ...
    init(form: TTp2Form): void {
        this._form = form
        this.form.edtSaisie.onkeydown = function (event): void {vueTp2.ajouterSaisie(event);}
        this.form.chkTri.onkeydown = function (): void {vueTp2.trierListe();}
        this.form.btnVider.onkeydown = function (): void {vueTp2.viderListe();}
        this.form.btnSupprimer.onkeydown = function (): void {vueTp2.supprimerLigne();}
    }

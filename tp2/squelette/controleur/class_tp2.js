class VueTp2 {
    init(form) {
        ...
        this.form.chkTri.onkeydown = function () { vueTp2.trierListe(); };
        this.form.btnVider.onkeydown = function () { vueTp2.viderListe(); };
        this.form.btnSupprimer.onkeydown = function () { vueTp2.supprimerLigne(); };
    }
